...
# ---------------------------------------------------------------------------
# Constants (scoring / thresholds — not part of public type surface)
# ---------------------------------------------------------------------------
...
# Catalog loading, path resolution, hashing, and log writing are
# implemented in _catalog.py and imported at the top of this module.
