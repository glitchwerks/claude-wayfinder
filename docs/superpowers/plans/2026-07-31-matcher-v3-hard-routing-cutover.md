...
| T-6 | `test_shadow_mode.py::test_stdout_decision_matches_live_fields_in_log` **re-pointed** | Assert `shadow["served_*"] == stdout[...]`, not `shadow["live_*"] == stdout[...]` | Deliberate update — see below |
